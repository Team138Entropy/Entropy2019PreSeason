...
class LineDetect:
    ...
    def process(self, inframe, outframe):
        ...
        #
        # and so on. When they do "img = cv2.imread('name.jpg', 0)"
        ...
        outimg = process(inimg)

        # Write a title:
        cv2.putText(outimg, "JeVois LineDetect", (3, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255))
